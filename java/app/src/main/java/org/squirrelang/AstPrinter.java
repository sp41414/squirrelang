...
class AstPrinter implements Expr.Visitor<String> {
    public static void main(String[] args) {
        Expr expression = new Expr.Binary(new Expr.Grouping(new Expr.Binary(new Expr.Literal(50),
        ...
        expression = new Expr.Ternary(new Expr.Binary(new Expr.Literal(60),
                new Token(TokenType.GREATER, ">", null, 1, 1), new Expr.Literal(50)), new Expr.Literal("yes"),
                new Expr.Literal("no"));
